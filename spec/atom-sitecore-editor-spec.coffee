AtomSitecoreEditor = require '../lib/atom-sitecore-editor'
...
describe "AtomSitecoreEditor", ->
  ...
  describe "when the atom-sitecore-editor:about event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      # has been created
      expect(workspaceElement.querySelector('.atom-sitecore-editor')).not.toExist()
      ...
      runs ->
        expect(workspaceElement.querySelector('.atom-sitecore-editor')).toExist()

        atomSitecoreEditorElement = workspaceElement.querySelector('.atom-sitecore-editor')
        expect(atomSitecoreEditorElement).toExist()
